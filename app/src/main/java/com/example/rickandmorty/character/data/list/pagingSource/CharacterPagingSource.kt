package com.example.rickandmorty.character.data.list.pagingSource

import androidx.paging.PagingSource
import androidx.paging.PagingState
import com.example.rickandmorty.character.domain.list.model.CharacterDomain

typealias CharactersPageLoader = suspend (pageIndex: Int, pageSize: Int) -> List<CharacterDomain>
