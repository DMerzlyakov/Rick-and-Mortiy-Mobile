...
class CharactersRecyclerViewAdapter(private val onClickRecyclerViewInterface: OnClickRecyclerViewInterface<CharacterUiModel>) :
    PagingDataAdapter<CharacterUiModel, CharacterViewHolder>(CharactersDiffUtil()) {
